    ...
    return (<section className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
          <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
            ...
            <div className="flex">
              <button className="bg-gray-100 inline-flex py-3 px-5 mt-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                <svg
              ...
              <button className="bg-gray-100 inline-flex py-3 px-5 mt-5 rounded-lg items-center ml-4 hover:bg-gray-200 focus:outline-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="w-6 h-6"
